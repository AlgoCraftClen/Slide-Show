...
const scripts = [
    ...
    "<strong>Product Examination:</strong> We will now review the submitted video evidence to examine the product for quality, size, and other physical requirements."
];
